...
> These are the exact message formats to use at each stage. Use dynamic values — never hardcode examples. No timestamps anywhere.
...
```
✅ Approved! Pushing to Airtable...
✅ Pushed to Airtable ([Airtable record ID])
...
```
Got it. Running Reflection Agent...
Rewriting [failing section only]...
